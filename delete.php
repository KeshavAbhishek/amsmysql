        ...
        <div id="child">
            ...
            <?php
                ...
                if($seat!=""){
                    ...
                    $sql = "DELETE FROM `customer` WHERE `seat`='$seat';";
                    $result = $con->query("SELECT * FROM customer WHERE `seat`='$seat'");
                    if($result->num_rows>0){
                        echo "<div class='success'>Ticket&nbsp;&nbsp;Deleted</div>";
                        $result = $con->query($sql);
                    }
                    else{
                        echo "<div class='error'>Seat : [".$seat."]<br>No such record found.</div>";
                    }
                }
                else{
           ...
           <!-- <div style="color: red !important;" class="success" id="redirect"></div> -->
            <div id="buttonFrame">
                ...
                <!-- <button class="btn" onclick="document.location.replace('show.php')">Show Ticket</button> -->
            </div>
        </div>
    </div>
    <!-- <script>
      var s = 3;
      setInterval(() => {    
        document.getElementById("redirect").innerHTML=`Redirecting to View Ticket page in ${s} Seconds...`;
        s = s - 1;
      }, 1000);
      setTimeout(() => {
        document.location.replace('show.php');
      }, 4000);
    </script> -->
</body>
</html>