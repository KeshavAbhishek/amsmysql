        ...
        <div id="child">
            ...
            <?php
                ...
                if(isset($_POST['name'])){
                    ...
                    $sql = "UPDATE `customer` SET `seat`='$seat', `name`='$name', `age`='$age', `email`='$email', `srcfrom`='$bairport', `srcto`='$dairport' WHERE `seat`='$seatC';";

                    if($con->query($sql) == true){
                        echo "<div class='success' id='ticketUpdated'>Ticket&nbsp;&nbsp;Updated.</div>";
                    }
                    else{
